...
def affine_decrypt_equation_with_multiplicative_inverse(a, b, n):
    ...
    a_inv = modinv(a, n)
    print(f"Ecuación de descifrado con inverso multiplicativo: D(x) = {a_inv}x + {(a_inv*additive_inverse)%n} % {n}")
